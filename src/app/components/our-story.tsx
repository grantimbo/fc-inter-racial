...
const OurStory = () => {
  return (
    <section id="our-story" className="bg-white py-20 px-6 font-sans text-black scroll-mt-16 md:scroll-mt-20">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-sm font-light mb-3">We proved that you don&rsquo;t need elite facilities to build an elite spirit. Our foundation was built on three simple pillars:</p>
